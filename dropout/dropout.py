...
with tf.Session() as sess:
    ...
    pfile.write('%3d %3d %3d %3d %.1f %.4f %.4f \n' % (d1,d2,d3,d4,dropout,validation_accuracy,validation_accuracy/train_accuracy))
    pfile.close()
    ...
    pfile.write('%3d %3d %3d %3d %.1f %.4f\n' % (d1,d2,d3,d4,dropout,test_accuracy))
    pfile.close()
